...
| gitshowcase | middleware.py | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/colmwoods/GitShowcase.dev/main/gitshowcase/middleware.py) | ![screenshot](documentation/validation/py-middleware.jpg) | Custom middleware to enforce non-www to www domain redirection before request processing |
| gitshowcase | signals.py | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/colmwoods/GitShowcase.dev/main/gitshowcase/signals.py) | ![screenshot](documentation/validation/py-signals.jpg) | Django signals used to automatically create or update related objects after user actions |
| gitshowcase | adapters.py | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/colmwoods/GitShowcase.dev/main/gitshowcase/adapters.py) | ![screenshot](documentation/validation/py-adapters.jpg) | Custom authentication adapter used to extend django-allauth behaviour for GitHub login |
| gitshowcase | apps.py | [PEP8 CI Link](https://pep8ci.herokuapp.com/https://raw.githubusercontent.com/colmwoods/GitShowcase.dev/main/gitshowcase/apps.py) | ![screenshot](documentation/validation/py-apps.jpg) | Application configuration file used to register the GitShowcase app and its signals |
...
| OAuth Failed | ![screenshot](documentation/responsiveness/mobile-login-fail.jpg) | ![screenshot](documentation/responsiveness/tablet-login-fail.jpg) | ![screenshot](documentation/responsiveness/desktop-login-fail.jpg) | If the user cancels GitHub OAuth authentication, they are redirected to a OAuth Failed page with a clear error message and navigation option. |
...
| OAuth Failed | ![screenshot](documentation/lighthouse/mobile-login-fail.jpg) | ![screenshot](documentation/lighthouse/desktop-login-fail.jpg) |
