...
**Site Mockups**
*([amiresponsive](https://ui.dev/amiresponsive?url=https://gitshowcase-dev-a0b7673e36ce.herokuapp.com), [techsini](https://techsini.com/multi-mockup), etc.)*
...
[GitHub Projects](https://www.github.com/colmwoods/GitShowcase.dev/projects) served as an Agile tool for this project. Through it, EPICs, User Stories, issues/bugs, and Milestone tasks were planned, then subsequently tracked on a regular basis using the Kanban project board.

![screenshot](documentation/gh-projects.png)

### GitHub Issues

[GitHub Issues](https://www.github.com/colmwoods/GitShowcase.dev/issues) served as an another Agile tool. There, I managed my User Stories and Milestone tasks, and tracked any issues/bugs.
...
The live deployed application can be found deployed on [Heroku](https://gitshowcase-dev-a0b7673e36ce.herokuapp.com).
...
1. Go to the [GitHub repository](https://www.github.com/colmwoods/GitShowcase.dev).
...
1. Log in to GitHub and locate the [GitHub Repository](https://www.github.com/colmwoods/GitShowcase.dev).
